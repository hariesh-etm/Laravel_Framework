        ...
        <div class="row  p-3">
            <div class="col-12 p-0">
                <div class="d-sm-flex align-items-center justify-content-between">
                    ...
                    <a href="" class="btn btn-primary" data-bs-toggle="offcanvas" data-bs-target="#addCanvas" aria-controls="offcanvasRight"   style="float: right;">Add Category</a>
                    </div>
                </div>
            </div>
        </div>
...
<div class="offcanvas offcanvas-end" tabindex="-1" id="addCanvas" aria-labelledby="offcanvasRightLabel">
  <div class="offcanvas-header">
    <b id="offcanvasRightLabel">Add Category</b>
...
$(document).on("click", ".edit-value", function (e) {
    ...
    $.ajax({
            type:'GET',
            url:'<?php echo url('/');?>/api/v1/category/get-categorydt',
            data:{'id': id},
            success:function(data) {
                console.log(data);
                if(data.status =="SUCCESS"){
