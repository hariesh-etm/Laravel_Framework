    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-12">
                ...
                <input type="text" name="role_id" class="form-control" placeholder="Enter role_id" id="role_id" required>
              </div>
             <div class="col-md-6">
                <label class="form-label">page_type</label> 
                <input type="text" name="page_type" class="form-control" placeholder="Enter page_type" id="page_type" >
              </div>
             <div class="col-md-6">
                <label class="form-label">create_option</label> 
                <input type="text" name="create_option" class="form-control" placeholder="Enter create_option" id="create_option" >
              </div>
             <div class="col-md-6">
                <label class="form-label">read_option</label> 
                <input type="text" name="read_option" class="form-control" placeholder="Enter read_option" id="read_option" >
              </div>
             <div class="col-md-6">
                <label class="form-label">update_option</label> 
                <input type="text" name="update_option" class="form-control" placeholder="Enter update_option" id="update_option" >
              </div>
             <div class="col-md-6">
                <label class="form-label">delete_option</label> 
                <input type="text" name="delete_option" class="form-control" placeholder="Enter delete_option" id="delete_option" >
              </div>
       ...
       .then(data => {
        ...
        $("#save_button_loading").hide();
           if (data.status == 'SUCCESS') {
               // console.log(data);
               Swal.fire({
            title: 'Role_permission Added Successfully',
            icon: 'success',
