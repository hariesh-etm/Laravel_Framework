        ...
        <div class="row  p-3">
            <div class="col-12 p-0">
                ...
                <div>
                    ...
                    <a href="" class="btn btn-primary" data-bs-toggle="offcanvas" data-bs-target="#addCanvas" aria-controls="offcanvasRight"  style="float: right;">Add Role</a>
                    </div>
                </div>
            </div>
        </div>
...
<div class="offcanvas offcanvas-end short_offcanvas" tabindex="-1" id="addCanvas" aria-labelledby="offcanvasRightLabel">
  <div class="offcanvas-header">
    <h5 id="offcanvasRightLabel">Add Role</h5>
                ...
                <div class="card-body">
                    <form action="#" id="addform" method="POST">
                        <div class="mb-3">
                            ...
                            <input type="text" name="role_name" class="form-control" placeholder="Enter Role Name" id="role_name" required>
                        </div>
                        <div class="text-end">
...
<div class="offcanvas offcanvas-end" tabindex="-1" id="updateCanvas" aria-labelledby="offcanvasRightLabel">
    <div class="offcanvas-header">
      <h5 id="offcanvasRightLabel">Update Role</h5>
      <button type="button" class="btn-close text-reset" data-bs-dismiss="offcanvas" aria-label="Close"></button>
    </div>
    <div class="offcanvas-body">
      <div class="row">
                  ...
                  <div class="card-body">
                      <form action="#" id="form" method="POST">
                        <input type="hidden" id="u_id" name="u_id">
                          <div class="mb-3">
                            <label class="form-label">Name <span class="text-danger">*</span></label>
                            <input type="text" name="u_role_name" class="form-control" placeholder="Enter Role Name" id="u_role_name" required>
                        </div>
                          <div class="text-end">
                              <button class="btn btn-primary" id="save_button" type="submit">Submit</button>
                              <button type="button" style="display:none;" id="save_button_loading" class="btn">Storing the data please wait ...</button>
