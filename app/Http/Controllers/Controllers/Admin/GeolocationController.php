...
class GeolocationController extends Controller
{
    ...
    function manage_geolocation_positionstack(){

      return view('admin.geolocation.list_geolocation', $this->data);
    }

    function manage_geolocation_google(){

        return view('admin.geolocation.list_geolocation_google', $this->data);
      }
