...
class PaypalController extends Controller
{
    ...
    public function __construct()
    {
        ...
        if(!empty($item)) {
          $key=$item->paypal_client_id;
          $secret=$item->paypal_secret;
          }else{
            $key="AQd7bZEpIALGqVmbh09aIiWnaTSp77VJv7chJBVXnN-nbWLQlNc_QwXYZitCoQ8mW_ghW_70rohtWGvH";
        ...
        // $paypal_configuration = \Config::get('paypal');
        $this->_api_context = new ApiContext(new OAuthTokenCredential($key, $secret));
    ...
    public function postPaymentWithpaypal(Request $request)
    {
        ...
        $this->mpayment->savepaymentresponse( $payment->getId(),"paypal_payment_id");
